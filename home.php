...
<body>
    ...
    <div class="head_container">
      <div class="box">
        <div class="text">
          ...
          <p>Discover the perfect blend of comfort and luxury at PARADISE Hotel Resort. We invite you to experience a world-class stay surrounded by breathtaking views and unparalleled hospitality. </p>
    ...
    <div class="container flex">
      ...
      <div class="right">
        <div class="heading">
          ...
          <p>Experience a world of sophistication and elegance. Our commitment to excellence ensures that every moment of your stay is memorable. We welcome you to PARADISE, where luxury meets tranquility. </p>
          <p>Indulge in the opulence of our accommodations and the warmth of our hospitality. Your journey into relaxation and rejuvenation begins here.</p>
  ...
  <section class="wrapper top">
    <div class="container">
      <div class="text">
        <h2>Our Amenities</h2>
        <p>Indulge in a range of luxurious amenities designed to elevate your stay at Luviana Hotel Resort. Our commitment to your comfort ensures a memorable experience. </p>
  ...
  <section class="wrapper wrapper2 top">
    <div class="container">
      <div class="text">
        ...
        <div class="para">
          <p>Discover the experiences of our guests and why they choose PARADISE Hotel Resort for their getaway. We take pride in providing exceptional service and creating lasting memories for our visitors. </p>
    ...
    <div class="container flex">
      ...
      <div class="right">
        <div class="text">
          ...
          <p> Indulge your senses in a gastronomic journey at our exquisite restaurant. Our chefs craft culinary masterpieces using the finest ingredients to tantalize your taste buds.</p>
        </div>
        <div class="accordionWrapper">
          <div class="accordionItem open">
            <h2 class="accordionIHeading">Italian Kitchen</h2>
            <div class="accordionItemContent">
              <p>Experience the rich flavors of Italy with our dedicated Italian Kitchen. From traditional pasta dishes to delectable desserts, our chefs bring the taste of Italy to your table.
              </p>
            </div>
          </div>
          <div class="accordionItem close">
            ...
            <div class="accordionItemContent">
              <p>Spice up your dining experience with the vibrant and bold flavors of our Mexican Kitchen. Savory tacos, enchiladas, and more await you for an authentic Mexican feast.
              </p>
            </div>
          </div>
          <div class="accordionItem close">
  ...
  <footer>
    <div class="container grid top">
      <div class="box">
        ...
        <p>  We welcome you to PARADISE, where luxury meets tranquility</p>
      ...
      <div class="box">
        ...
        <ul>
          ...
          <li>September in PARADISE Hotel</li>
          <li>Live Music Concerts at PARADISE</li>
        </ul>
      </div>
      ...
      <div class="box">
        ...
        <ul>
          <li>NMAM INSTITUTE OF TECH 123456</li>
